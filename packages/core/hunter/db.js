...
// Runtime state must not live inside node_modules (a reinstall would wipe it),
// so both the data dir and the db file are overridable via env.
const DATA_DIR = process.env.HUNTER_DATA_DIR || path.join(__dirname, "..", "data");
