...
const features: Feature[] = [
  {
    ...
    boxCls: "border-violet-600/20 bg-violet-600/5",
    cardCls: "hover:border-violet-600/30",
    icon: (
      <svg
        ...
        className="lucide lucide-chart-pie w-6 h-6 text-violet-600 stroke-[3px]"
      >
  ...
  },
  {
    ...
    boxCls: "border-blue-600/20 bg-blue-600/5",
    cardCls: "hover:border-blue-600/30",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="lucide lucide-chart-column w-6 h-6 text-blue-600 stroke-[3px]"
      >
  ...
  },
  {
    ...
    boxCls: "border-teal-600/20 bg-teal-600/5",
    cardCls: "hover:border-teal-600/30",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="lucide lucide-shield w-6 h-6 text-teal-600 stroke-[3px]"
      >
  ...
  },
  {
    ...
    boxCls: "border-amber-600/20 bg-amber-600/5",
    cardCls: "hover:border-amber-600/30",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="lucide lucide-zap w-6 h-6 text-amber-600 stroke-[3px]"
      >
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-center">
            <motion.div
              {...fadeUp}
              className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-brand-600/10 bg-brand-600/5 whitespace-nowrap"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <motion.h2
              {...fadeUp}
              className="mt-6 w-full max-w-[686px] text-brand-950 text-center font-onest text-[32px] sm:text-[40px] lg:text-[52px] font-semibold leading-tight lg:leading-[58px] tracking-[-1.2px] sm:tracking-[-1.8px]"
            >
              Kuasai Karirmu
            ...
            <motion.p
              {...fadeUp}
              className="mt-3 w-full max-w-[514px] text-brand-950 text-center font-inter text-base sm:text-lg font-normal leading-relaxed sm:leading-7 opacity-80"
            >
          ...
          <div className="mt-12 lg:mt-16 grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
            {features.map((feature) => (
              <motion.div
                key={feature.title}
                {...fadeUp}
                className={`flex flex-col items-start shrink-0 border border-brand-950/10 overflow-hidden bg-white group w-full rounded-[24px] sm:rounded-[32px] transition-colors ${feature.cardCls}`}
              >
                ...
                <div className="p-6 sm:p-10 flex flex-col sm:flex-row items-start gap-5 self-stretch bg-white">
                  <div className={`w-10 h-10 p-2 flex items-center justify-center border ${feature.boxCls} rounded-lg shrink-0`}>
                    {feature.icon}
                  </div>
                  <div className="flex flex-col gap-[10px]">
                    <h3 className="text-brand-950 font-onest text-xl sm:text-2xl font-semibold leading-tight sm:leading-[30px] tracking-[-0.8px]">
                      {feature.title}
                    </h3>
                    <p className="text-brand-950 font-inter text-base sm:text-lg font-normal leading-relaxed sm:leading-[28px] opacity-80">
                      {feature.description}
                    </p>
                  </div>
                </div>
