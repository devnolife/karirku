...
const benefits: Benefit[] = [
  {
    ...
    icon: (
      <svg {...iconProps} className="lucide lucide-user w-5 h-5 text-brand-600">
  ...
  },
  {
    ...
    icon: (
      <svg {...iconProps} className="lucide lucide-badge-check w-5 h-5 text-teal-600">
  ...
  },
  {
    ...
    icon: (
      <svg {...iconProps} className="lucide lucide-gauge w-5 h-5 text-blue-600">
        <path d="m12 14 4-4" />
  ...
  },
  {
    ...
    icon: (
      <svg {...iconProps} className="lucide lucide-zap w-5 h-5 text-violet-600">
  ...
  },
  {
    ...
    icon: (
      <svg {...iconProps} className="lucide lucide-map w-5 h-5 text-amber-600">
  ...
  },
  {
    ...
    icon: (
      <svg {...iconProps} className="lucide lucide-briefcase w-5 h-5 text-brand-600">
  ...
  },
  {
    ...
    icon: (
      <svg {...iconProps} className="lucide lucide-user-check w-5 h-5 text-teal-600">
  ...
  },
  {
    ...
    icon: (
      <svg {...iconProps} className="lucide lucide-timer w-5 h-5 text-amber-600">
  ...
  },
  {
    ...
    icon: (
      <svg {...iconProps} className="lucide lucide-chart-pie w-5 h-5 text-blue-600">
  ...
  },
  {
    ...
    icon: (
      <svg {...iconProps} className="lucide lucide-users w-5 h-5 text-brand-600">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <h3 className="text-brand-950 font-onest text-[20px] md:text-[24px] font-semibold leading-[26px] md:leading-[30px] tracking-[-0.6px] md:tracking-[-0.8px]">
          {benefit.title}
        </h3>
        <p className="text-brand-950 font-inter text-base md:text-[18px] font-normal leading-[24px] md:leading-[28px] opacity-80">
          {benefit.description}
        </p>
      </div>
    </motion.div>
        ...
        <div className="w-full max-w-[1248px] mx-auto">
          <div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-[48px] justify-between">
            <div className="w-full lg:max-w-[622px] flex flex-col items-start lg:sticky lg:top-[120px] self-start">
              <div className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-brand-600/10 bg-brand-600/5 whitespace-nowrap mb-8">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <h2 className="text-brand-950 font-onest text-[32px] sm:text-[42px] md:text-[52px] font-semibold leading-[38px] sm:leading-[48px] md:leading-[58px] tracking-[-1.2px] md:tracking-[-1.8px] mb-3">
                Kendalikan penuh pertumbuhan karirmu dengan{" "}
                <span className="text-black/40 font-playfair italic font-semibold">tools</span>{" "}
                cerdas
              </h2>
              <p className="text-brand-950 font-inter text-lg md:text-[20px] font-normal leading-[24px] md:leading-[30px] opacity-80 mb-16 max-w-[560px]">
              ...
              <div className="flex flex-wrap gap-3 mb-12">
                {tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-6 py-3 border border-brand-950/10 rounded-full text-brand-950 font-inter text-[16px] md:text-[18px] font-normal hover:bg-[#F6FDFF] transition-colors cursor-default"
                  >
                    {tag}
                  </span>
                ))}
            ...
            >
              <div className="lg:sticky lg:top-[120px] lg:h-[800px] h-auto flex items-start w-full lg:overflow-hidden overflow-visible">
                ...
                <div className="hidden lg:flex flex-col items-center mr-10 xl:mr-12 relative w-[2px] bg-brand-600/10 self-stretch">
                  <motion.div
                    className="w-full bg-brand-600 absolute top-0 left-0 h-full"
