...
export function GuidesExplorer({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="act-card-2 act-wash-petal-soft flex flex-col items-start gap-4 border-[rgba(245,158,11,0.2)] p-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
