  ...
  return (
    <div className="act-rise app-page space-y-8">
      ...
      {gap.skills.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="act-bezel">
            <div
              className="act-bezel-core p-6"
              style={{ "--core-bg": "radial-gradient(120% 130% at 50% 0%, #ffffff 40%, var(--act-sky-100) 140%)" } as React.CSSProperties}
            >
          ...
          <div className="act-bezel">
            <div
              className="act-bezel-core p-6"
              style={{ "--core-bg": "radial-gradient(120% 130% at 50% 0%, #ffffff 40%, #eceafa 140%)" } as React.CSSProperties}
            >
      ...
      {profile.skills.length > 0 && (
        <div className="act-bezel">
          <div className="act-bezel-core p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {profile.skills.map((s) =>
                s.verified ? (
                  <span key={s.id} className="inline-flex items-center gap-1.5 rounded-full border border-[rgba(109,86,252,0.3)] bg-[rgba(109,86,252,0.08)] px-3 py-1.5 text-sm font-semibold text-[var(--act-iris)]">
